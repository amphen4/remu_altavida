...
<head>
  ...
  <title>Ingreso - Sistema Remuneraciones - Corporacion Altavida</title>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="{{asset('templates/AdminLTE-master')}}/plugins/iCheck/square/blue.css">
...
<div class="login-box">
  <div class="login-logo">
    <a href="{{asset('')}}"><b>Corporación</b>    Altavida</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">

    <p class="login-box-msg">Bienvenido(a), porfavor inicie sesión.</p>
    ...
    <form method="POST" action="{{ route('login') }}">
      ...
      <div class="alert alert-danger alert-dismissible">
        ...
        <h4><i class="icon fa fa-exclamation-circle"></i> Encontramos un error.</h4>
        Correo electrónico ingresado no existe
      </div>
      @endif
